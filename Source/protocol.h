...
#define U_EFFECTS2		(1<<24) // Darkplaces - 1 byte, this is .effects & 0xFF00 (second byte)
#define U_FRAMEINTERVAL	(1<<25) // mankrip - QC frame_interval - be careful, as this uses the same number as U_COLORMOD
...
#define svc_letterbox		60	// mankrip - svc_letterbox
#define svc_vibrate			61	// mankrip
