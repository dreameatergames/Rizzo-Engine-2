...
// mankrip - Deathmatch/Coop not at the same time - begin
...
// mankrip - Deathmatch/Coop not at the same time - end
// mankrip - TIMESCALE extension - begin
...
// mankrip - TIMESCALE extension - end
/*
=======================
Host_InitLocal
======================
...
// 2001-10-20 TIMESCALE extension by Tomaz/Maddes  start
	Cvar_RegisterVariableWithCallback (&host_timescale, Host_CheckTimescaleValue); // mankrip
// 2001-10-20 TIMESCALE extension by Tomaz/Maddes  end
	...
	Cvar_RegisterVariableWithCallback (&deathmatch, Host_CheckDeathmatchValue); // mankrip - Deathmatch/Coop not at the same time - edited
	Cvar_RegisterVariableWithCallback (&coop, Host_CheckCoopValue); // mankrip - Deathmatch/Coop not at the same time - edited
...
// config.cfg cvars
	...
	{
#ifndef _arch_dreamcast // mankrip - VMU saves
	//	f = fopen (va("%s/config.cfg",com_gamedir), "wb"); // mankrip - reduced config file - edited
		f = fopen (va("%s/makaqu.cfg",com_gamedir), "wb"); // mankrip - config.cfg replacement - edited
// mankrip - VMU saves - begin
#else
		f = fopen ("/ram/makaqu.cfg", "wb");
#endif
// mankrip - VMU saves - end
		if (!f)
		{
			Con_Printf ("Couldn't write makaqu.cfg.\n"); // mankrip - config.cfg replacement - edited
			return;
		}
...
// mankrip - VMU saves - begin
	...
	VMU_Save ("/ram/makaqu.cfg", filename, "Makaqu config   ", description);
	}
#endif
// mankrip - VMU saves - end
	}
...
====================
*/
extern void M_Credits_f (void); // mankrip
extern void SCR_Adjust (void); // mankrip - screen positioning
