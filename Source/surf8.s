...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8_mip0a)
C(R_DrawSurfaceBlock8_mip0a):
...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8_mip1a)
C(R_DrawSurfaceBlock8_mip1a):
	pushl	%ebp				// preserve caller's stack frame
	pushl	%edi
	pushl	%esi				// preserve register variables
	pushl	%ebx
...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8_mip2a)
C(R_DrawSurfaceBlock8_mip2a):
	pushl	%ebp				// preserve caller's stack frame
	pushl	%edi
	pushl	%esi				// preserve register variables
	pushl	%ebx
...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8_mip3a)
C(R_DrawSurfaceBlock8_mip3a):
	pushl	%ebp				// preserve caller's stack frame
	pushl	%edi
	pushl	%esi				// preserve register variables
	pushl	%ebx
