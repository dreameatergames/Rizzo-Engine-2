...
cvar_t	d_mipscale = {"d_mipscale", "0.875"};
...
void (*d_drawturb) (espan_t *pspan); // mankrip
...
void D_SetupFrame (void)
{
	...
	if (r_dowarp)
		screenwidth = vid.width;//WARP_WIDTH; // mankrip - hi-res waterwarp & buffered video - edited
	else
//		screenwidth = vid.rowbytes;
		screenwidth = abs (vid.rowbytes); // mankrip - edited
