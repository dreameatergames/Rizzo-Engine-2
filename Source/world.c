...
#else // mankrip - replaced
// mankrip - copied from inside3d.com - begin
void SV_TouchLinks ( edict_t *ent, areanode_t *node )
{
   link_t      *l, *next;
   edict_t      *touch;
   ...
   if (!list)
   {
      ...
      list = (edict_t **) Z_Malloc (MAX_EDICTS * sizeof (edict_t *));
   }
loc0:;
   // ensure
   touched = 0;
...
#endif
// mankrip - copied from inside3d.com - end
