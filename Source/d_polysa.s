...
LDraw8:
	...
	movb	%dh,%ah
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// mankrip - transparent pixels in alias models
	jz		Lp1							// mankrip - transparent pixels in alias models
	movw	%bp,(%ecx)
...
LDraw7:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// mankrip - transparent pixels in alias models
	jz		Lp2							// mankrip - transparent pixels in alias models
	movw	%bp,2(%ecx)
	movb	0x12345678(%eax),%al
LPatch7:
	movb	%al,1(%edi)
...
LDraw6:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// mankrip - transparent pixels in alias models
	jz		Lp3							// mankrip - transparent pixels in alias models
	movw	%bp,4(%ecx)
	movb	0x12345678(%eax),%al
LPatch6:
	movb	%al,2(%edi)
...
LDraw5:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// mankrip - transparent pixels in alias models
	jz		Lp4							// mankrip - transparent pixels in alias models
	movw	%bp,6(%ecx)
	movb	0x12345678(%eax),%al
LPatch5:
	movb	%al,3(%edi)
...
LDraw4:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// mankrip - transparent pixels in alias models
	jz		Lp5							// mankrip - transparent pixels in alias models
	movw	%bp,8(%ecx)
	movb	0x12345678(%eax),%al
LPatch4:
	movb	%al,4(%edi)
...
LDraw3:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// mankrip - transparent pixels in alias models
	jz		Lp6							// mankrip - transparent pixels in alias models
	movw	%bp,10(%ecx)
	movb	0x12345678(%eax),%al
LPatch3:
	movb	%al,5(%edi)
...
LDraw2:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// mankrip - transparent pixels in alias models
	jz		Lp7							// mankrip - transparent pixels in alias models
	movw	%bp,12(%ecx)
	movb	0x12345678(%eax),%al
LPatch2:
	movb	%al,6(%edi)
...
LDraw1:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// mankrip - transparent pixels in alias models
	jz		Lp8							// mankrip - transparent pixels in alias models
	movw	%bp,14(%ecx)
	movb	0x12345678(%eax),%al
LPatch1:
	movb	%al,7(%edi)
...
LExactlyOneLong:
	...
	movb	(%ebx),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// mankrip - transparent pixels in alias models
	jz		LNextSpanESISet				// mankrip - transparent pixels in alias models
	movw	%bp,(%ecx)
	movb	0x12345678(%eax),%al
LPatch9:
	movb	%al,(%edi)
