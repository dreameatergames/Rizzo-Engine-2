...
int In_AnalogCommand(int key); // mankrip
int In_IsAxis(int key); // mankrip
...
// mankrip - controllers' buttons for menu input - begin
...
#endif
// mankrip - controllers' buttons for menu input - end

typedef enum {key_game, key_console, key_message, key_menu} keydest_t;

extern qboolean shift_function; // mankrip - function shift
extern keydest_t	key_dest;
extern char *keybindings[K_NUMKEYS]; //256
extern char *shiftbindings[K_NUMKEYS]; //256 // mankrip - function shift
...
void Key_SetShiftBinding (int keynum, char *binding); // mankrip - function shift
void Key_ClearStates (void);
int Key_StringToKeynum (char *str); // mankrip

// mankrip - on-screen keyboard - begin
int M_OnScreenKeyboard_Key (int key);
void M_OnScreenKeyboard_Reset (void);
// mankrip - on-screen keyboard - end
